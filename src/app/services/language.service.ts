...
export const TRANSLATION_DICTIONARY: Translations = {
  ...
  'notes.title': { bn: 'AI স্টাডি টিউটর ও কনসেপ্ট নোটস', en: 'AI Topic Tutor & Study Notes' },
  'notes.subtitle': { bn: 'টপিকের গভীর জ্ঞান, নিয়ম, বাস্তব উদাহরণ ও মনে রাখার শর্টকাট কৌশল', en: 'In-depth pedagogy, formulas, examples & memory mnemonics' },
  ...
  'notes.realLifeExample': { bn: '💡 শ্রেণিকক্ষের বাস্তব উদাহরণ ও প্রয়োগ', en: '💡 Classroom Example & Application' },
  'notes.memoryMnemonics': { bn: '🧠 সহজে মনে রাখার সহজ কৌশল / শর্টকাট ট্রিকস', en: '🧠 Memory Mnemonics & Shortcut Tricks' },
  'notes.commonMistakes': { bn: '⚠️ টেট পরীক্ষায় সাধারণ ভুল ও সতর্কতা', en: '⚠️ Common Exam Mistakes to Avoid' },
  'notes.examTakeaways': { bn: '📝 দ্রুত রিভিশন পয়েন্টস', en: '📝 Quick Revision Takeaways' },
  'notes.saveBtn': { bn: '💾 এই টপিকটি সংরক্ষণ করুন', en: '💾 Save Topic to Vault' },
  ...
  'notes.copied': { bn: 'নোট সফলভাবে কপি করা হয়েছে!', en: 'Note copied to clipboard!' },
  'notes.copyBtn': { bn: '📋 নোট কপি করুন', en: '📋 Copy Notes' },
  'notes.deleteBtn': { bn: '🗑️ মুছুন', en: 'Delete Note' },
