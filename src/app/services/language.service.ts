...
export const TRANSLATION_DICTIONARY: Translations = {
  ...
  'review.similarQBtn': { bn: '🔄 একই ধরণের ১০টি প্রশ্নের টেস্ট দিন', en: '🔄 Start 10 Similar Questions Quiz' },
  'review.similarQuizBtn': { bn: '🔄 একই ধরণের ১০টি প্রশ্নের টেস্ট দিন', en: '🔄 Start 10 Similar Questions Quiz' },
